...
export function HomeContact() {
  return (
    <section id="contact" style={{ padding: '160px 56px 120px' }}>
      ...
      <h2 style={{ margin: 0, fontFamily: FONTS.serif, fontWeight: 300, fontSize: 'clamp(64px, 9vw, 144px)', lineHeight: 0.95, letterSpacing: '-0.035em', maxWidth: 1200 }}>
        Got something{' '}
        <span style={{ fontFamily: FONTS.serifIt, fontStyle: 'italic', color: PALETTE.accent }}>worth building</span>?<br />
        Let's talk.
      </h2>
      <a href="mailto:pandey.k.ashish.86@gmail.com" style={{ display: 'inline-flex', alignItems: 'center', gap: 16, marginTop: 56, fontFamily: FONTS.serif, fontWeight: 300, fontSize: 36, color: PALETTE.fg, letterSpacing: '-0.015em', borderBottom: `1px solid ${PALETTE.hairline}`, paddingBottom: 12 }} className="ap-link">
        pandey.k.ashish.86@gmail.com
        <span style={{ fontSize: 24, color: PALETTE.accent }}>↗</span>
      </a>
      <div style={{ marginTop: 80, paddingTop: 32, borderTop: `1px solid ${PALETTE.hairline}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontFamily: FONTS.mono, fontSize: 11, letterSpacing: '0.14em', color: PALETTE.fgMute, flexWrap: 'wrap', gap: 16 }}>
